...
import { TRANSLATIONS, BUSSGELDER as BUSSGELDER_I18N } from "./i18n/translations";
...
export default function Home(){
  ...
  const run=useCallback(()=>setResult(compute({start,planned,drivenToday,blockSincePause,drivenWeek,drivenBiweek,extUsed,redRests,splitBreak},TRANSLATIONS[lang])),[start,planned,drivenToday,blockSincePause,drivenWeek,drivenBiweek,extUsed,redRests,splitBreak,lang]);
  ...
  return(
    <>
      ...
      <div style={{minHeight:'100vh',background:C.bg,color:C.txt}} className="dot-grid">
        ...
        {/* ── Nav ── */}
        <Nav C={C} dark={dark} setDark={setDark} />
